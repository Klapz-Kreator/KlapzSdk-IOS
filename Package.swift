...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            resources: [.copy("images/wihteklapz.png"),.copy("images/klapzicon.png"),.copy("images/noti.png"),.copy("images/klap2.png"),.copy("fonts/Montserrat-Bold.ttf"),.copy("fonts/Montserrat-Medium.ttf"),.copy("fonts/Montserrat-Regular.ttf")]
            ),
    ]
)
